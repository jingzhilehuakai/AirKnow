...
class AirQualityStatusView: UIView {
    ...
    lazy var titleButton: UIButton = {
        ...
        titleButtonInternal.titleLabel?.adjustsFontSizeToFitWidth = true
    ...
    lazy var descriptionLabel: UILabel = {
        ...
        descriptionLabelInternal.adjustsFontSizeToFitWidth = true
    ...
    fileprivate func refreshUI() {
        ...
        let statusLevelThemeColor: ThemeColorPicker = (targetModel?.statusTheme)!
